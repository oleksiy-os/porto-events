	...
	tests := []struct {
	...
	}{
		{
			...
			want: model.Event{
				...
				Description: `<p><b>The temporary exhibition “Este mundo não nos pertence” (&quot;This world does not belong to us&quot;) marks the fourth great moment of artistic and cultural dissemination of Espaço João Espregueira Mendes (EJEM), at Museu Futebol Clube do Porto, with national and foreign authors.</b></p><p>From the private collection of Isabel Mota and Fernando Pereira, painting, sculpture, drawing and photography come together in an interesting approach to contemporary art from the end of the 20th century to the present.</p><p>Open to the public on May 12, the exhibition has been extended and can continue to be visited until December 31. Entry is free.</p><p>Complete information at<b> </b><a href="https://www.fcporto.pt/pt/museu/agenda/e-2022-05-12-pt-este-mundo-nao-nos-pertence-obras-da-colecao-isabel-mota-e-fernando-pereira-espaco-joao-espregueira-mendes"><b>Futebol Clube do Porto website</b></a><b>.</b></p>` + "\n",
		...
		},
		{
			...
			want: model.Event{
				...
				Description: `<p><b>Soil simulations of an imagined territory through which one can look for traces of minerals with energetic potential and present soil samples from different origins with varied compositions that are mounted in two-dimensional planes – it is this fictional reality that can be watched closely in the new exhibition “Fictional Grounds” by the artistic collective berru.</b></p><p>Created in Porto, the collective won the Sonae Media Art 2019 award, and has already exhibited and was responsible for installations at institutions such as Calouste Gulbenkian Foundation, BoCA Biennial of Contemporary Arts, and The Old Truman Brewey (London).</p><p>Viewed critically and driven by the urgency of the current ecological catastrophe, the exhibition establishes a subtle relationship with the world of earthworks by pioneering Land Art artists such as Robert Smithson, Richard Long or the famous exhibition by Walter de Maria when in 1977 he filled a gallery in New York with 140 tons of earth.</p><p>Entry is free.</p>` + "\n",
		...
		},
		{
			...
			want: model.Event{
				...
				Description: `<p><b>The Walking Art Maps – #asbelasarteseacidade exhibition, especially dedicated to international students, within the scope of the 35th anniversary of ERASMUS+, opens this Wednesday at the Exhibition Pavilion of the Faculty of Fine Arts of the U. Porto.</b></p><p>The exhibition brings together works from the FBAUP collection that are associated with works installed in public and private spaces, easily accessible. Six routes are proposed, where works by some of the artists, architects and designers of the Belas Artes do Porto are identified, which punctuate and characterize the city in various ways.</p><p>Walking Art Maps unfolds between the FBAUP Exhibition Pavilion and an <a href="http://www.walkingartmaps.fba.up.pt"><b>online platform</b></a>. </p><p></p><p>Complete information at <a href="https://sigarra.up.pt/fbaup/pt/noticias_geral.ver_noticia?p_nr=26922"><b>FBAUP website</b></a>. </p>` + "\n",
		...
		},
		{
			...
			want: model.Event{
				...
				Description: `<p><b>Three architects - Diogo Aguiar, Dulcineia Santos and Nuno Melo Sousa - proposed to illuminate the conceptual bases of their three architectural discourses in the exhibition entitled &quot;SO WHAT&quot;,  evocative of Duke Ellington&#x27;s restlessness and continual experimentation.</b></p><p>The opening session will include a three-way conversation, moderated by Hélder Casal Ribeiro, curator of the exhibition.</p><p>&quot;SO WHAT&quot; will feature a parallel set of conferences, guided tours and Educational Service activities, upon registration.</p><p><i>  </i><br/>Complete information at <a href="https://casadasartes.gov.pt/so-what-tres-arquitetos-tres-discursos/"><b>Casa das Artes website</b></a>.</p>` + "\n",
		...
		},
		{
			...
			want: model.Event{
				...
				Description: `<p><b>“Luís de Matos IMPOSSIBLE Live” ends its national tour at Coliseu do Porto with shows on January 13th and 14th.</b></p><p>The most awarded Portuguese magician, distinguished three times by the Academy of Magical Arts in Hollywood, and the youngest in history to receive the Devant Award, from The Magic Circle, brings a new journey through the world of illusion where the impossible becomes reality and the limits of imagination are challenged at every moment.</p><p>Luís de Matos will have at his side four of the greatest magicians in the world today: from the United States of America, Dan Sperry, from Spain, Javier Botía, from France, Norbert Ferré, and from South Korea, Yu Hojin.</p><p></p><p>Complete information at <a href="https://www.coliseu.pt/evento/20230113-luis-de-matos-impossivel-ao-vivo"><b>Coliseu do Porto website</b></a>.</p>` + "\n",
